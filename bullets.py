...
LastEditTime: 2021-05-28 14:58:41
LastEditors: DJ
'''
...
class Bullet(QtCore.QObject):
    ...
    def __init__(self, max_y, list_bullet, class_bullet="player") -> None:
    ...
    def init_attribute(self):
        ...
        def func_get_path_img_bullet(class_bullet): return dict_path_img_bullet.get(
            class_bullet, r'resources\photo\bul02.png')  # 创建 lambda匿名函数
        path_img_bullet = func_get_path_img_bullet(
            self.class_bullet)  # 调用匿名函数获取对应图片路径
    ...
    def move(self):
        ...
        # 如果是敌方的子弹，向下移动
            ...
            self.y += self.move_speed
        # 判断子弹是否出界，如果子弹出界，从子弹列表中删除子弹，并删除该对象
