...
LastEditTime: 2021-05-27 15:11:58
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_FormGame):
    ...
    '''    
    def init_game(self):
        self.bool_game_over=True # 指示游戏是否结束
        path_img_gameover=r'resources\photo\game_over.png'
        self.pixmap_gameover=QPixmap(path_img_gameover).scaledToWidth(self.width(),Qt.KeepAspectRatio)
        self.pixmap_gameover.scaledToWidth(100,Qt.TransformationMode.)
        # self.pixmap_gameover
        # 设置玩家名称和玩家头像文件路径
