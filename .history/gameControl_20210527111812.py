...
LastEditTime: 2021-05-27 11:18:12
LastEditors: DJ
'''
import random
...
class GameControl():
    ...
    '''    
    def __init__(self,background,plane_palyer,list_enemy,list_bullet,str_name_player,path_player_img,list_background_img_path,max_x,) -> None:
    ...
    def create_enemy(self):
        ...
        enemy=PlaneEnemy(class_plane,'enemy',self.list_bullet,)