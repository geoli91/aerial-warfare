...
LastEditTime: 2021-05-26 21:35:51
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_Form):
    ...
    def keyPressEvent(self, a0: QtGui.QKeyEvent) -> None:
        dict_key_func={Qt.Key_A:self.plane_palyer.move_left, Qt.Key_D:self.plane_palyer.move_right,Qt.Key_W:self.plane_palyer.move_up,Qt.Key_}
        if a0.key()==Qt.Key_A:
