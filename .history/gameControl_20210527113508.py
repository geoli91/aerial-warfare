...
LastEditTime: 2021-05-27 11:35:08
LastEditors: DJ
'''
import random
...
class GameControl():
    ...
    def __init__(self,background,plane_palyer,list_enemy,list_bullet,str_name_player,path_player_img,list_background_img_path,max_x,max_y) -> None:
        ...
        # 使用定时器定时创建敌军
        qtimer_create_enemy=QtCore.QTimer()
        qtimer_create_enemy.start(self.float_new_enemy_speed*1000)
        qtimer_create_enemy.timeout.connect(self.create_enemy)
        print(222)
