...
LastEditTime: 2021-05-26 14:00:54
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_DialogGame):
    ...
    def draw_img(self):
        ...
        _photo_view->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
_photo_view->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
