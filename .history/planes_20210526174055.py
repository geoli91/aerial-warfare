...
LastEditTime: 2021-05-26 17:40:55
LastEditors: DJ
'''
...
class PlanePlayer(BasePlane):
    def __init__(self,class_plane,class_bulet,list_bullet) -> None:
        # 重写了子类的 __init__ 方法，如果还希望继承父类的 __init__ 方案，可以使用 super 
        super(PlanePlayer,self).__init__(class_plane,class_bulet,list_bullet)
        # 初始化飞机图标
