...
LastEditTime: 2021-05-26 17:23:58
LastEditors: DJ
'''
...
class Bullet():
    ...
    def init_attribute(self):
        ...
        func_get_path_img_bullet=lambda class_bullet:dict_path_img_bullet.get(class_bullet,r'resources\photo\bul02.png') # 创建 lambda
