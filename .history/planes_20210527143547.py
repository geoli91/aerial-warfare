...
LastEditTime: 2021-05-27 14:35:43
LastEditors: DJ
'''
...
class BasePlane(QtCore.QObject):
    ...
    def bomb(self):
        ...
        if self.class_plane='player':
            ...
            func_class_path=lambda class_plane:dict_class_path.get(class_plane,r'resources\photo\bomb5.png')
            path_img_bomb=func_class_path(self.class_plane)
