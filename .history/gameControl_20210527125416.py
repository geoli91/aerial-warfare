...
LastEditTime: 2021-05-27 12:54:16
LastEditors: DJ
'''
import random
...
class GameControl():
    ...
    def crack_detect_object(self,object_a,object_b):
        rect_a=[object_a.x,object_a.y,object_a.pixmap.width(),object_a.pixmap.width()]
        rect_2=[object_a.x,object_a.y,object_a.pixmap.width(),object_a.pixmap.width()]
