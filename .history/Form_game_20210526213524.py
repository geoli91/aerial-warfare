...
LastEditTime: 2021-05-26 21:35:23
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_Form):
    ...
    def keyPressEvent(self, a0: QtGui.QKeyEvent) -> None:
        dict_key_func={Qt.Key_A:self.plane_palyer.move_left, Qt.Key_D:self.plane_palyer.move_right,}
        dict_a={Qt.Key_A:self.plane_palyer.move_left,'b':2}
        if a0.key()==Qt.Key_A:
