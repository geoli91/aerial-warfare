...
LastEditTime: 2021-05-26 15:51:19
LastEditors: DJ
'''
...
class GameControl():
    ...
    '''    
    def __init__(self,background,our_plane,list_enemy,list_bullet,str_name_player,path_player_img,list_background_img) -> None:
