...
LastEditTime: 2021-05-26 22:36:48
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_FormGame):
    ...
    def init_game(self):
        ...
        # 创建定时器，定时刷新
                # 使用Qtimer执行定时任务
        self.qtimer_compass=QTimer() # 创建 QTimer 对象
        self.qtimer_compass.start(1000) # 开始定时，传入参数为时间间隔，单位为 毫秒
        self.qtimer_compass.timeout.connect(self.set_compass_inner_rotation)
