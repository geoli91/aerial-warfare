...
LastEditTime: 2021-05-26 15:49:02
LastEditors: DJ
'''
...
class GameControl():
    ...
    @param {*} str_name_player 玩家图标
    '''    
    def __init__(self,background,our_plane,list_enemy,list_bullet,str_name_player,path_player_img) -> None:
