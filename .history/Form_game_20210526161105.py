...
class FormGame(QtWidgets.QDialog,Ui_Form):
    ...
    def init_game(self):
        ...
        self.gameControl=GameControl(self.background,self.plane_palyer,self.list_enemy,self.list_enemy,self.list_bullet,self.str_name_player,self.plane_palyer,self.plane_palyer)
        self.x,self.y=0,0
