...
LastEditTime: 2021-05-26 21:55:21
LastEditors: DJ
'''
...
class PlanePlayer(BasePlane):
    ...
    def plane_flow(self,value):
        ...
        func_value_path=lambda value:dict.get(value,r'resources\photo\plane.png')
        path_pixmap=func_value_path()
        if value==""

    def move_left(self):
        path_pixmap=r'resources\photo\planeLeft.png'
        self.pixmap=QtGui.QPixmap(path_pixmap)
        return super().move_left()

    def move_right(self):
        path_pixmap=r'resources\photo\planeRight.png'
        self.pixmap=QtGui.QPixmap(path_pixmap)
