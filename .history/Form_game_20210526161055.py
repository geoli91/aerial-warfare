...
LastEditTime: 2021-05-26 16:10:55
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_Form):
    ...
    def init_game(self):
        ...
        self.gameControl=GameControl(self.background,self.plane_palyer,self.list_enemy,self.plane_palyer,self.plane_palyer,self.plane_palyer,self.plane_palyer,self.plane_palyer)
        self.x,self.y=0,0
