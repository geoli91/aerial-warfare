...
LastEditTime: 2021-05-27 16:53:37
LastEditors: DJ
'''
...
class BasePlane(QtCore.QObject):
    ...
    def __init__(self,class_plane,class_bulet,list_bullet,max_x,max_y) -> None:
        ...
        self.qtimer_bomb_change=QtCore.QTimer(self)
        self.qtimer_bomb_change.timeout.connect(self.bomb_change)

        
        QtCore.QObject.__init__(self)

    """将HP设置为飞机属性，以便使用 setter 监控飞机血量"""a
    @property
    def HP(self):
        return self.__HP
    ...
    def bomb(self):
        print(2)
        self.qtimer_bomb_change.start(20)
        QtCore.QObject.__init__(self)
        # import time
        # time.sleep(100)
        self.remove_self()
