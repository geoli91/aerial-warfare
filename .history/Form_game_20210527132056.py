...
LastEditTime: 2021-05-27 13:20:56
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_FormGame):
    ...
    def paint_stat(self):
        ...
        path_player_img=r'resources\photo\imgHeadSheep.png'
        pixmap_player_img=QPixmap(path_player_img)
        self.painter.drawPixmap(10,10,pixmap_player_img)
        self.painter.drawRect(10,90,102,10)
        self.painter.fillRect(11,91,self.plane_palyer.HP,9,QColor.red)

        self.painter.drawRect(10,110,102,10)
        self.painter.fillRect(11,111,100,9)

        self.painter.drawText(10,130,'Player:{str_name_player}')
        self.painter.drawText(10,150,f'Score:{self.gameControl.int_score}')
