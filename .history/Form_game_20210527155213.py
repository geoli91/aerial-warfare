...
LastEditTime: 2021-05-27 15:52:08
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_FormGame):
    signal_game_close=pyqtSignal() # 用于向主窗体发送游戏界面关闭的信号
    '''
    ...
    def init_game(self):
        ...
        self.list_bullet=[]
        # 实例化玩家飞机对象
        self.plane_palyer=PlanePlayer('player','player',self.list_bullet,self.width(),self.height(),self.keyboard)
    ...
    def closeEvent(self, a0: QtGui.QCloseEvent) -> None:
        reply = QMessageBox.question(self, '结束游戏？', 'You sure to quit?',
