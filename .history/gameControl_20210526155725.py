...
LastEditTime: 2021-05-26 15:57:25
LastEditors: DJ
'''
import random
...
class GameControl():
    ...
    def create_stage(self):
        ...
        index_background_img=random.randint(0,len(self.list_background_img_path)-1) # 使用 random.randint(int_min.int_max) 生成指定范围内的整数，包括int_min和int_max
        path
