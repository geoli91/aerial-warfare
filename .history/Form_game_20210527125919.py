...
LastEditTime: 2021-05-27 12:59:19
LastEditors: DJ
'''
import sys
...
class FormGame(QtWidgets.QDialog,Ui_FormGame):
    ...
    def __init__(self,parent=None):
        ...
        self.pushButton.click.connect(self.detect_crack)

    def detect_crack(self):
        self.gameControl.crack_detect_object(self.plane_palyer,self.list)
    ...
    def keyPressEvent(self, a0: QtGui.QKeyEvent) -> None:
        ...
        func_key=lambda key:dict_key_func.get(key,self.pass_key)()
        func_key(a0.key())
        # 刷新显示
        self.update()
